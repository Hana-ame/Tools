...
def ssh_cmd(cmd):
    return subprocess.run(
        ["ssh", "root@cloudcone.moonchan.xyz", cmd],
        capture_output=True, text=True, timeout=120
    )


def test_v4():
    print("=== cloudcone IPv4 -> opencode.ai/zen/v1/chat/completions ===")
    r = ssh_cmd(
...
def test_v6():
    print("=== cloudcone IPv6 -> opencode.ai/zen/v1/chat/completions ===")
    r = ssh_cmd(
...
def test_models():
    print("=== cloudcone IPv4 -> opencode.ai/zen/v1/models ===")
    r = ssh_cmd(
