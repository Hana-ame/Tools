...
def ssh_cmd(cmd):
    return subprocess.run(
        ["ssh", "-p", "26275", "root@bwh.moonchan.xyz", cmd],
        capture_output=True, text=True, timeout=120
    )


def test_v4():
    print("=== bwh.moonchan.xyz IPv4 -> opencode.ai/zen/v1/chat/completions ===")
    r = ssh_cmd(
...
def test_v6():
    print("=== bwh.moonchan.xyz IPv6 -> opencode.ai/zen/v1/chat/completions ===")
    r = ssh_cmd(
...
def test_models():
    print("=== bwh.moonchan.xyz IPv4 -> opencode.ai/zen/v1/models ===")
    r = ssh_cmd(
