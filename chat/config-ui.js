...
function renderParamTable(rows) {
    ...
    for (let i = 0; i < rows.length; i++) {
        ...
        if (r.locked) {
            ...
            keyEl.style.cssText = 'font-size:0.82rem;font-weight:600;color:var(--text2);min-width:100px;font-family:"SF Mono",Consolas,monospace;border:1px solid var(--border2);border-radius:6px;padding:4px 6px;outline:none;';
        ...
        inp.style.cssText = 'width:100%;padding:6px 8px;border:1px solid var(--border2);border-radius:8px;font-size:0.82rem;outline:none;font-family:"SF Mono",Consolas,monospace;';
