...
if __name__ == "__main__":
    ...
    data = {
        "model": "DeepSeek-V3",
        "max_tokens": max_tokens - len(content) - len(os.getenv("SYSTEM_PROMPT"))-len(os.getenv("SYSTEM_PROMPT_V3")),
        "messages": [
            {"role": "system", "content": os.getenv("SYSTEM_PROMPT")},
            {"role": "assistant", "content": os.getenv("SYSTEM_PROMPT_V3")},
...
def get_response_from_api(messages):
    ...
    url = "https://infer-modelarts-cn-southwest-2.modelarts-infer.com/v1/infers/f354eacc-a2c5-43b4-a785-e5aadca988b3/v1/chat/completions"
